...
export const eventFields = {
  ...
  export const eventsData = [
    // Existing events unchanged until ID 4
    {
      id: 1,
      name: "binary",
      image: "battle_bytes",
      ...
      venue: "TBD",
      rules: [
        "No cheating, hacking, or use of third-party software.",
        "Players must use mobile devices (some tournaments may allow tablets/emulators).",
        "All players must use the latest version of BGMI.",
        "No abusive language, toxicity, or unsportsmanlike behavior.",
        "Teams should have the required number of players (usually 4 per squad).",
      ],
      prize: "TBD",
    ...
    },
    {
      ...
      rules: [
        ...
        "Prelims Round: Teams must clear the Prelims Round to qualify for the final competition.",
    ...
    },
    {
      ...
      rules: [
        ...
        "The first team to score 21 points or more wins the game if it happens before the end of regular playing time.",
      ...
      requiresPayment: true, // New field
      registrationFee: 500, // Example fee in INR
      qrCode: "/images/basketball-qr.png", // Placeholder QR code path
    },
    {
      id: 5,
      name: "War of Words",
      ...
      venue: "TBD",
      rules: [
        "Each speaker gets 5 minutes to present.",
    ...
    },
    {
      ...
      rules: [
        ...
        "All participants must bring their Institute's ID cards.",
        "Decision of the judges will be final and binding on all teams.",
    ...
    },
    {
      ...
      rules: [
        ...
        "Posters must be of the specified size i.e. A3 and it should be original.",
        "Participants would be given 2 hours to complete their posters.",
        "No use of electronic device during the time period.",
    ...
    },
    {
      ...
      rules: [
        "The event is open to photographers of all levels, ages, and nationalities.",
        "Participants must register online or offline by [insert date].",
        "Any device, whether a mobile phone or professional camera, is allowed.",
        "Submitted images must be in JPEG format.",
        "Images must have a minimum resolution of 16:9 aspect ratio (horizontal).",
        "Basic editing (e.g., brightness, contrast, saturation) is allowed, but excessive manipulation or tampering with the image is not permitted.",
        "Submissions will open at 12 pm and close at 2 pm.",
        "Participants can submit one image per category.",
        "Submissions must include your name (e.g., Revant_bvicam).",
        "Images will be judged based on creativity, technical skills, and composition.",
        "A panel of three judges will select the winners.",
        "The metadata of your image will be checked to ensure the originality of your submission.",
        "Participants retain the copyright to their submitted images.",
        "By participating, participants grant the event organizers permission to use their images for promotional purposes.",
      ],
    ...
    },
    {
      ...
      rules: [
        "Round 1: Debugging Challenge - Participants will be given 5 code snippets with bugs.",
        ...
        "Round 2: Final Coding Contest - 3 problems of varying difficulty.",
        "Round 2: Participants must solve at least 2 problems to qualify for ranking.",
    ...
    },
    {
      ...
      requiresPayment: true, // New field
      registrationFee: 600, // Example fee in INR
      qrCode: "/images/volleyball-qr.png", // Placeholder QR code path
    },
  ];
